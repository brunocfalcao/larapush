...
Each time you upload your codebase, Larapush stores that codebase plus your configured "pre" and "post" scripts both in your local computer and in your web server. By default these folders are on your storage_path("app/larapush"). You can change this path on your larapush.php configuration file.

Each of the transaction that is created will then be stored with the same transaction code in your storage.
